...
{   TextView date;
    ...
    String UserId;
    String checkinDate,checkOutDate,max_child,max_adult;
    String hotelId;
    ...
    public void onListSelected(ArrayList<RoomData> data1,int offer_prece,int actual_price,ArrayList<String> roomId,ArrayList<String> roomCount)
    {
        ...
        reserve.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Log.d("dsjfjksddsdjhbh", String.valueOf(roomId));
                Log.d("dsjfjkdsgdfgsddsdjhbh", String.valueOf(roomCount));
                Log.d("dsfgsddsdjhbh", String.valueOf(checkinDate));
                if (offer_prece != 0)
                {
                     UtilsMethod.INSTANCE.reserveRoom(RoomActivity.this, hotelId,
                            checkinDate,
                            checkOutDate, max_adult, max_child, String.valueOf(offer_prece), String.valueOf(actual_price), UserId, roomId, roomCount);
                    Log.d("dfcvbvcvb",offer_prece+"      "+actual_price);
                    ...
                    editor.putString("max_adult",max_adult);
                    editor.putString("max_child",max_child);
