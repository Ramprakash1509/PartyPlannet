...
import com.app.partyplanet.Activity.ChangePassword;
import com.app.partyplanet.Activity.GetLocation;
import com.app.partyplanet.Activity.SignUp;
...
*/
    ...
    {  btn_changepassword=v.findViewById(R.id.btn_changepassword);
        ...
        Log.d("id",id);
        Log.d("hewgydyf",Fname);
        Log.d("pic",ApplicationConstant.INSTANCE.baseUrl+pic);
